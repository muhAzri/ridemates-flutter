...
mixin _$AuthResponseModel {
 ...
 UserModel get user; AuthTokensModel get tokens; bool get needsProfileSetup; bool get needsLocation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,user,tokens,needsProfileSetup,needsLocation);

@override
String toString() {
  return 'AuthResponseModel(user: $user, tokens: $tokens, needsProfileSetup: $needsProfileSetup, needsLocation: $needsLocation)';
}
...
@useResult
$Res call({
 UserModel user, AuthTokensModel tokens, bool needsProfileSetup, bool needsLocation
});


$UserModelCopyWith<$Res> get user;$AuthTokensModelCopyWith<$Res> get tokens;
...
/// Create a copy of AuthResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? user = null,Object? tokens = null,Object? needsProfileSetup = null,Object? needsLocation = null,}) {
  return _then(_self.copyWith(
user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as UserModel,tokens: null == tokens ? _self.tokens : tokens // ignore: cast_nullable_to_non_nullable
as AuthTokensModel,needsProfileSetup: null == needsProfileSetup ? _self.needsProfileSetup : needsProfileSetup // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserModel user,  AuthTokensModel tokens,  bool needsProfileSetup,  bool needsLocation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.user,_that.tokens,_that.needsProfileSetup,_that.needsLocation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserModel user,  AuthTokensModel tokens,  bool needsProfileSetup,  bool needsLocation)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.user,_that.tokens,_that.needsProfileSetup,_that.needsLocation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserModel user,  AuthTokensModel tokens,  bool needsProfileSetup,  bool needsLocation)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.user,_that.tokens,_that.needsProfileSetup,_that.needsLocation);case _:
  return null;
...
class _AuthResponseModel implements AuthResponseModel {
  const _AuthResponseModel({required this.user, required this.tokens, this.needsProfileSetup = false, this.needsLocation = false});
...
@override $UserModelCopyWith<$Res> get user;@override $AuthTokensModelCopyWith<$Res> get tokens;
...
/// Create a copy of AuthResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? user = null,Object? tokens = null,Object? needsProfileSetup = null,Object? needsLocation = null,}) {
